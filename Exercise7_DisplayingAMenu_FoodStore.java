...
public class Exercise7_DisplayingAMenu_FoodStore{
...
public Exercise7_DisplayingAMenu_FoodStore(int choose){
...
JOptionPane.showMessageDialog(null,"Total cost: "+total+"0");
System.exit(0);
}
